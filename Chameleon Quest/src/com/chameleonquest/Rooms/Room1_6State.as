package com.chameleonquest.Rooms 
{
	...
	public class Room1_6State extends PlayState
	{
		...
		override public function create():void
		{
			...
			Preloader.logger.logLevelStart(6, {"src": 5});
			Preloader.tracker.trackPageview(Preloader.flag + "/level-6");
			...
			var gate1:StoneGate = new StoneGate(8, 21, -1, 480, StoneGate.YELLOW);
			var gate2:StoneGate = new StoneGate(7, 29, -1, 480, StoneGate.GREEN);
			elems.add(gate1);
			elems.add(gate2);
		...
		override public function update():void
		{
			...
			if (player.x < 0) {
				...
				Preloader.tracker.trackPageview(Preloader.flag + "/level-6-end");
