package com.chameleonquest.Rooms 
{
	...
	public class Room1_2State extends PlayState
	{
		...
		{	
			...
			elems.add(new Platform(new Array(new FlxPoint(40, 192), new FlxPoint(19 * 16, 192)), 60));
			...
			spacehelp = new FlxText(7*16, 24*16, 132, "SPACE");
			spacehelp.setFormat(null, 14, 0x555555, "center");
			spacehelp.alpha = .5;
			this.add(spacehelp);
			
			var morehelp:FlxText;
			morehelp = new FlxText(5 * 16, 25 * 16, 182, "GRAB ROCKS TO FIRE");
